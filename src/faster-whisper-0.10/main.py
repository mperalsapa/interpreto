...
model = WhisperModel("deepdml/faster-whisper-large-v3-turbo-ct2", device="cpu", compute_type="float32")

segments, info = model.transcribe("../../references/audio/Kung_Fu_Panda_4_(2024)_[tmdbid-1011985]_Cast.mp3")
print("Detected language '%s' with probability %f" % (info.language, info.language_probability))
